...
public class ModalProdutoPage {
	...
	public String obterMensagemProdutoAdicionado() {
		...
		/*
		 * Espera Explicida mais flexibilidade pois atua em um �nico Elemento
		 * driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); //Espera
		 * explicida webdriver wait - new WebDriver(driver, 10);
		 * wait.until(ExpectedConditions.visibilityOfLocad(mensagemProdutoAdicionado));
		 */
